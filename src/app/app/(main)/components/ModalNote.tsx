...
function ModalNote({ setIsOpenModal, setIsUpdated }: ModalNoteProps) {
    const { toast } = useToast()
    //const { setIsUpdated } = useFetchNotes()
    ...
    return(
        <ModalPage>
            <ModalContainer>
                <ModalHeader>
                    <ModalTitle className="pl-6">Criar nova nota</ModalTitle>
                ...
                <Form { ...form }>
                    <form onSubmit={handleSubmit}>
                        <FormContent className="border-none">
                            ...
                            >
                                {isLoading ? 'Verificando...' : 'Criar nota'}
                            </Button>
                        </FormContent>
                    </form>
                </Form>
